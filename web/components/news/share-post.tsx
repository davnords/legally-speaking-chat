...
const SharePost = () => {
  const handleShare = (platform: any, event: any) => {
    ...
    switch (platform) {
      case 'facebook':
        shareOnFacebook(blogPostUrl);
        break;
      case 'twitter':
        shareOnTwitter(blogPostUrl);
        break;
      case 'linkedin':
        shareOnLinkedIn(blogPostUrl);
        break;
      default:
        break;
    }
  ...
  return (
    <>
      <a
        href="#0"
        className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-blue bg-opacity-10 text-body-color duration-300 hover:bg-opacity-100 hover:text-white sm:ml-3"
        onClick={(event) => handleShare('linkedin', event)}
      >
        <svg
          width="16"
          height="16"
      ...
      <a
        href="#0"
        className="ml-3 mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-blue bg-opacity-10 text-body-color duration-300 hover:bg-opacity-100 hover:text-white"
        onClick={(event) => handleShare('twitter', event)}
      >
        <svg
          width="18"
          height="14"
      ...
      <a
        href="#0"
        className="ml-3 mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-blue bg-opacity-10 text-body-color duration-300 hover:bg-opacity-100 hover:text-white"
        onClick={(event) => handleShare('facebook', event)}
      >
