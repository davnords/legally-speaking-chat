            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  Join our team and democratize the access to legal services
                </h2>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="/images/blog/david-nordstrom.png"
                            alt="author"
                            fill
                          />
                        </div>
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex items-center justify-center rounded-full bg-blue py-2 px-4 text-sm font-semibold text-white"
                    >
                      Hiring
                    </a>
                  </div>
                ...
                <div>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Through some work I managed to build a functioning product by myself. However, I am both deficient in the Software Development and legal skills needed to scale this project.
                    I have a goal, to revolutionize the way that law is practiced, starting with Sweden. But to reach this goal I will need talented people to join me.
                    There is a large opportunity to be captured, not just for the consumer market but supercharging existing legal adivsors with AI technology. 
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    To launch a compelling product there I need help. I will be working on this project out of passion, mostly on evenings and weekends, you are free to join with whatever skillset and ambitions you have and steer the project into a direction you see fit.
                    I will strive for exellence and I know that to build a good product the people will be crucial. You can join to work very little or a lot, but I will compensate you fairly for the output you generate and will bring in talented people on the cap-table. 
                  </p>
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-blue bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
