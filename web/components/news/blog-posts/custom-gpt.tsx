              ...
              <div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    In this blog post I dive into the plans for ChatterFlow to finetune our own proprietary model based on the open sourced weights available today.
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/blog/peft-image.png"
                        alt="image"
                        fill
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    After the publication of the weights of Meta&apos;s large scale language model (LLM) LLaMA 2, there has been a surge in the capabilities of cheap finetuning.
                    Through 🤗 HuggingFace&apos;s PEFT library, users have been enabled to finetune LLMs with consumer hardware. The results have been staggering, for specific tasks these simpler LLMs outperform the likes of  
                    <strong className="text-primary dark:text-white">
                      &nbsp;GPT4&nbsp;
                    </strong>
                    when tuned on custom datasets. 
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Collecting user data through our interactions, we can leverage internal data to finetune an LLM.
                    <span className="text-primary underline dark:text-white">
                      &nbsp;However, LLaMA 2 has limited Swedish knowledge
                    </span>
                    . Once this is provided, or I assemble a team that can train our own pre-trained model from scratch, I must rely on a sub-par Swedish model in LLaMA 2 or pay for finetuning of GPT4.
                  </p>
